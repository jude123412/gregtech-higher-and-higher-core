...
public class GTHHMaterialIconSet {
    ...
    public static final MaterialIconSet COSMICNEUTRONIUM = new MaterialIconSet("cosmic_neutronium", MaterialIconSet.SHINY);
    public static final MaterialIconSet INFINITYCATALYST = new MaterialIconSet("infinity_catalyst", MaterialIconSet.SHINY);
