...
public class HeatExchangerRecipeLogic extends AbstractRecipeLogic {
    ...
    public HeatExchangerRecipeLogic(MetaTileEntityFissionReactor tileEntity) {
    ...
    protected void trySearchNewRecipe() {
        ...
        if (!didStartRecipe) {
            ...
            for (int i = 0; i < importItems.getSlots(); i++) {
                ...
                Recipe fissionRecipe = GTHHRecipeMaps.FISSION_RECIPES.findRecipe(GTValues.V[GTValues.MAX],
