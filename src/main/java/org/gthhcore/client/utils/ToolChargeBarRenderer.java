package org.gthhcore.client.utils;
...
public class ToolChargeBarRenderer {
    ...
    public static void renderBarsItem(GTHHMetaItem<?> metaItem, ItemStack stack, int xPosition, int yPosition) {
        boolean renderedDurability = false;
        GTHHMetaItem<?>.GTHHMetaValueItem valueItem = metaItem.getItem(stack);
